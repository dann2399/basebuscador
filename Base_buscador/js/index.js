...
$('#submitButton').click(function(){
    let ciudad = $('#selectCiudad option:selected').val().replace(" ","+");
    let tipo = $('#selectTipo option:selected').val().replace(" ","+");
    ...
    var url = "buscador.php?ciudad=" + $('#selectCiudad option:selected').val().replace(" ","+") + "&tipo="+ $('#selectTipo option:selected').val().replace(" ","+")+ "&precio="+$('#rangoPrecio').val().replace(";","%3B");
